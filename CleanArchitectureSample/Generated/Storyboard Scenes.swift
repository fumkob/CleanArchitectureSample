...
internal enum StoryboardScene {
  ...
  internal enum Root: StoryboardType {
    ...
    internal static let initialScene = InitialSceneType<CleanArchitectureSample.RootViewController>(storyboard: Root.self)

    internal static let root = SceneType<CleanArchitectureSample.RootViewController>(storyboard: Root.self, identifier: "root")
  }
